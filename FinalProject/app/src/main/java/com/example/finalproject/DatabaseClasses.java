...
public class DatabaseClasses extends SQLiteOpenHelper {
    ...
    public static final String COURSEDAYS = "COURSEDAYS";
    public static final String COURSEHOURS = "COURSEHOURS";
    public static final String CAPACITY = "CAPACITY";
    public static final String INSTRUCTOR = "INSTRUCTOR";
    public static final String ENROLLEDSTUDENTS = "ENROLLEDSTUDENTS";
    ...
    public void changeClassName(String currentClassName,String newClassName){
    ...
    public void changeClassID(String currentClassID,String newClassID){
        SQLiteDatabase db =  this.getWritableDatabase();
        ContentValues cv = new ContentValues();
    ...
    public boolean add(Class classNew){
